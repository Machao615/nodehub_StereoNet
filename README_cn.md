...
**⚠️ 重要说明：**
- 本项目所需的C++编译源码来自于：https://github.com/D-Robotics/hobot_stereonet
- 一切以官方源码仓库为准
- 本仓库仅用于说明文档
- 具体更新请以官方源码仓库和RDK手册为准：https://developer.d-robotics.cc/rdk_doc/Robot_development/boxs/function/hobot_stereonet
- **一般使用情况下，可以直接通过`apt install`安装功能包，无需编译**
- **只有在需要自定义开发时才需要编译源码**
...
**⚠️ 注意：只有在需要修改算法或添加自定义功能时才需要源码编译。**

1. **前置条件：**
   - RDK平台，已安装Ubuntu 22.04系统
   - 已安装ROS2 Humble环境
   - 已安装开发工具
...
对于常规使用，建议直接通过`apt install`安装预编译功能包。
